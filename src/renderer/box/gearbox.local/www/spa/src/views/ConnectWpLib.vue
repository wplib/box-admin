<template>
  <div class="is-vertical-center is-fullheight is-height-max has-text-centered">
    <div class="column is-half is-offset-one-quarter">
      <div class="noselect">
        <h1 class="m-b-5 is-size-1">Connect to WpLib</h1>
        <strong class="is-size-5 has-text-grey">Your Wordpress Workflow!</strong>
      ...
      <div class="button-actions">
        ...
        <a href="#" class="button is-link is-rounded m-r-5">
          Login to Wplib
        </a>
        <button
          @click="openUrl"
          class="button is-link is-outlined is-rounded m-l-5"
        >
          Learn More
        </button>
      </div>
