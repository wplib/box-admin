<template>
  <div id="wrapper">
    <img id="logo" src="~@/assets/images/logo.png" alt="WPLib Box">
    <main>
      <div class="text">
        <h1>Welcome to the WPLib Box</h1>
        <p>The Developer Experience Project for WordPress</p>
      </div>
